...
_RULE_PATTERNS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "context_label": None,
        "pattern": re.compile(
            r"\b(FR-N1X1|H07[VRU][RN]?-?[FKR]?|H05[VRU][VR]-?[F]?)\b",
            re.IGNORECASE,
        ),
        "value_group": 1,
        "strip_spaces": True,
    ...
    # =========================================================================
    {
        ...
        "pattern": re.compile(
            r"temp[eé]rature\s+(?:ambiante?|ext[eé]rieure?|de\s+r[eé]f[eé]rence|de\s+calcul|de\s+service)"
            r"[^\n.]{0,80}?(-?\d+)\s*°?\s*C\b",
            re.IGNORECASE,
        ),
        "value_group": 1,
        ...
        "unit": "°C",
        "confidence": 0.85,
        "desc_template": "Temperature ambiante de reference : {value} °C",
    },
    {
        "rule_type": "condition_environnementale",
        "context_label": "temperature",
        "pattern": re.compile(
            r"(-?\d+)\s*°\s*C\b[^\n.]{0,60}?"
            r"(?:ambiante?|ext[eé]rieure?|de\s+r[eé]f[eé]rence|de\s+calcul)",
            re.IGNORECASE,
        ),
        "value_group": 1,
        "strip_spaces": False,
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"humidit[eé]\s+(?:relative?|maximale?|admissible|[Hh][Rr])[^\n.]{0,50}?(\d{2,3})\s*%",
            re.IGNORECASE,
        ),
        "value_group": 1,
        "strip_spaces": False,
        "unit": "%",
        "confidence": 0.8,
        "desc_template": "Humidite relative maximale : {value} %",
    },
    {
        "rule_type": "condition_environnementale",
