...
def get_export_detail(
    ...
    """Retourne les lignes paginées d'un export CANECO."""
    _check_project_access(project_id, db, current_user)
    ...
    total = caneco_repository.count_lines(db, export_id)
    lines = caneco_repository.paginate_lines(db, export_id, page=page, per_page=per_page)
